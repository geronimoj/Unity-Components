...
public struct BufferList<T> : IEnumerable<T>, IEnumerable
{
    ...
    public void Add(T item) => BufferList.buffer.Add(item);
    public void AddRange(IEnumerable<T> collection) => BufferList.buffer.AddRange((IEnumerable<object>)collection);

    /// <summary>
    /// Empties the buffer
    /// </summary>
    public void Clear() => BufferList.Clear();
